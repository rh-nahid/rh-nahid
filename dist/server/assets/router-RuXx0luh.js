...
const appCss = "/assets/styles-BjRQ4o-F.css";
...
const $$splitComponentImporter = () => import("./index-C20wedNg.js");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of Rakibul Hasan Nahid — SQA engineer & full-stack developer crafting reliable software with PHP, SQL and meticulous testing."
    }, {
      property: "og:title",
      content: "Rakibul Hasan Nahid — Aspiring SQA Engineer"
    }, {
      property: "og:description",
      content: "SQA engineer & full-stack developer based in Dhaka, Bangladesh."
    }],
    links: [{
      rel: "preconnect",
